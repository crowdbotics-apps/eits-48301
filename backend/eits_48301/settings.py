"""
Django settings for eits_48301 project.
...
WSGI_APPLICATION = 'eits_48301.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "eits_48301 API",
    "DESCRIPTION": "API documentation for eits_48301 App",
    "VERSION": "v1",
}
